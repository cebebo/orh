...
@Component({
  selector: 'app-fs-anfrageformular',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './fs-anfrageformular.component.html',
  styleUrl: './fs-anfrageformular.component.scss'
})
export class FsAnfrageformularComponent {
...
selectOption(type: string, value: string) {
  if (type === 'catering') {
    this.optCatering = value;
    this.bookingData.catering = value;
  }
  this.openDropdown = null; // Dropdown nach Auswahl schließen
}
